                ...
                <div class="card-header pb-0">
                   ...
                   {{-- <div class="d-flex justify-content-between">
                    ...
                    <div class="form-group row mt-4 m-b-2">
                        ...
                        <div class="col-6">
                            <x-form.input wire:model="name" name="name" type="text" class="col-auto" placeholder="Enter Name Post " :value="request('name')" />
                        ...
                        <table class="table text-md-nowrap" id="example4">
                            ...
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr>
                                        <td>{{ $loop->index	 }}</td>
                                        <td><img src="{{ asset('storage/' . $post->image) }}" width="50"
                                                height="50" alt=""></td>
                                        <td>{{ $post->title }}</td>
